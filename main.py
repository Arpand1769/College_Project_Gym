...
def call():
    ...
    if new == "Username" or passData == "Password":
        ...
        messagebox.showinfo("Showinfo", f"Your Account Successfully Created")
        root.destroy()
...
Button(frame,text="Sign in",width=42,pady=7,bg="#57a2f8",fg="#fff",activeforeground="#fff",border=0,font=("Microsoft YaHei UI Light",9),command=call).place(x=25,y=215)
